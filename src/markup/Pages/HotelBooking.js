                ...
                <div className='col-lg-8'>
                  <div className='d-flex info-bx m-b30'>
                    <div className='tour-title'>
                      ...
                      <p>
                        <i className='fa fa-map-marker m-r5'></i>Yeshwanthpur,
                        Bangalore{' '}
                        <Link className='text-primary'>View on Map</Link>
                      </p>
                      <p>
                        <span className='site-button button-sm button-gray'>
                          Hotel
                        </span>{' '}
                        <span className='site-button button-sm'>Bar</span> Tour
                      </p>
                    </div>
                  ...
                  <div className='tour-days'>
                    ...
                    <div className='row'>
                      ...
                      <div className='col-md-12 col-lg-12 col-sm-12'>
                        ...
                        <ul className='list-hand-point primary'>
                          <li>
                            The FabHotel RMS Comforts is situated on 5th Main in
                            the Mathikere Extension area
                          </li>
                          <li>
                            Yeshwantpur Junction Railway Station is 1.8 km,
                            while Krantivira Sangolli Rayanna Railway Station is
                            7.3 km from the hotel
                          </li>
                          <li>
                            Sandal Soap Factory Metro Station is 2.6 km and
                            Kempegowda International Airport is a 40-minute
                            drive (30.5 km)
                          </li>
                          <li>
                            Some of the prominent landmarks near the hotel
                            include BBMP Office (700 m), Ramaiah Institute of
                            Technology (750 m), Indian Institute of Science (950
                            m), BEL-THALES Systems Limited (1.5 km), ISRO (1.6
                            km), RTO Office Yeshwanthpura (1.8 km), Antrix
                            Corporation Limited (1.9 km), Bharat Electronics
                            Limited (2.1 km) and Professional Tax Office (2.5
                            km)
                          </li>
                          <li>
                            Sandal Soap Factory Metro Station is 2.6 km and
                      ...
                      <div className='col-md-12 col-lg-12 col-sm-12'>
                        ...
                        <ul className='list-hand-point primary'>
                          <li>
                            The hotel has a restaurant that treats you with a
                            wide range of dishes across multiple cuisines
                          </li>
                          <li>
                            Sri Krishna Bhavan (53 m), Shree Sagar (63 m),
                            Delight (72 m), Reddy Mess (140 m), Star Biryani
                            Center (290 m) and Indira Canteen (300 m) are among
                      ...
                      <div className='row'>
                        ...
                        <div className='col-md-12 col-lg-12 col-xl-12 col-sm-12 col-12'>
                          <div className='booking-total'>
                            <h3 className='d-flex'>
                              Rs.40000 <span>Sub Total1 room for 1 night</span>
                            </h3>
                          </div>
                        </div>
                        <div className='col-md-12 col-lg-12 col-xl-12 col-sm-12 col-12'>
