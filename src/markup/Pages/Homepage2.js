      ...
      <div>
        ...
        <Slider className='slider-wrapper' {...settings}>
          {content.map((item, index) => (
            ...
            >
              <div className='inner'>
                <button className='site-button react-slide-btn'>
                  {item.button}
                </button>
        ...
        <div className='content-block' id='page_content'>
              ...
              <div className='row'>
                <div className='col-lg-4 col-md-6 col-sm-12'>
                  <div className='featured-bx style2'>
                    <div className='featured-media'>
                      <img
                        src={require('./../../images/featured/pic1.jpg')}
                        alt=''
                      />
                    ...
                    <div className='featured-content text-white'>
                      <div>
                        <h2 className='title'>
                          <Link to={'packages'}>Westorn Europe</Link>
                        </h2>
                        <p>
                ...
                <div className='col-lg-4 col-md-6 col-sm-12'>
                  <div className='featured-bx style2'>
                    ...
                    <div className='featured-content text-white'>
                      <div>
                        <h2 className='title'>
                          <Link to={'packages'}>Philippines</Link>
                        </h2>
                        <p>
                          It is a long established fact that a reader will be
                          distracted by the readable content.
                ...
                <div className='col-lg-6 col-md-6 col-sm-12'>
                  <div className='featured-bx style2'>
                    <div className='featured-media'>
                      <img
                        src={require('./../../images/featured/pic4.jpg')}
                        alt=''
                      />
                ...
                <div className='col-lg-6 col-md-12 col-sm-12'>
                  <div className='featured-bx style2'>
                    <div className='featured-media'>
                      <img
                        src={require('./../../images/featured/pic5.jpg')}
                        alt=''
                      />
          ...
          <div
            className='section-full content-inner bg-img-fix overlay-black-middle'
          ...
          >
            <div className='container'>
              <div className='video-banner-box'>
                <div>
                  <Link
                    to={'https://www.youtube.com/watch?v=Dj6CKxQue7U'}
