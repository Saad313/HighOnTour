        ...
        <div className='bg-white content-inner dlab-about-1'>
          <div className='container'>
            <div className='section-head text-black text-center'>
              <h2 className='m-b0 text-uppercase'>
                Popular hotel destinations
              </h2>
              <p className='font-18'>
                If you’re looking for a truly memorable family break, here you
                find the lowest price on the right hotel for you. It's
                indescribable.
              </p>
            </div>
            <div className='row'>
                  ...
                  >
                    <div className='dlab-media dlab-img-effect dlab-img-overlay2'>
                      ...
                      <div className='dlab-info-has p-a20 text-white no-hover'>
                        ...
                        <Link
                          to={'./hotelbooking'}
                          className='site-button outline outline-2 radius-xl'
                        >
                          Book Now
                        </Link>
                      </div>
