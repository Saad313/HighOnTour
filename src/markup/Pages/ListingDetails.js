          ...
          <div className='listing-info-box'>
            ...
            <div className='listing-info'>
              ...
              <div className='listing-info-right text-center'>
                <Link to={''} className='site-button gray mr-3'>
                  <i className='la la-heart-o m-r5'></i> Favorite{' '}
                </Link>
                ...
                <div className='col-xl-8 col-lg-7 col-md-12'>
                  <div className='content-box'>
                    <div className='content-header'>
                      <h3 className='title'>
                        <i className='la la-star-o m-r5'></i> average reviews
                      </h3>
                    </div>
                    ...
                    <div className='content-footer content-btn'>
                      ...
                      >
                        <i className='la la-star-o m-r5'></i> ADD A REVIEW
                      </Link>
                    </div>
                  </div>
                  <div className='content-box'>
                    <div className='content-header'>
                      <h3 className='title'>
                        <i className='la la-file-text m-r5'></i> description
                      </h3>
                    </div>
                    <div className='content-body'>
                      <p>
                  ...
                  <div className='content-box'>
                    <div className='content-header'>
                      <h3 className='title'>
                        <i className='la la-list-alt m-r5'></i>listing features
                      </h3>
                    </div>
                    <div className='content-body'>
                      <ul className='icon-box-list list-col-4'>
                        <li>
                          <Link to={''} className='icon-box-info'>
                  ...
                  <div className='content-box'>
                    <div className='content-header'>
                      <h3 className='title'>
                        <i className='la la-file-image-o'></i> photos
                      </h3>
                    </div>
                    <div className='content-body'>
                  ...
                  <div className='content-box'>
                    <div className='content-header'>
                      <h3 className='title'>
                        <i className='la la-video-camera m-r5'></i>videos
                      </h3>
                    </div>
                    <div className='content-body'>
                        ...
                        <ul>
                          <li>
                            <div className='dlab-post-thum video-bx'>
                              <img
                                src={require('./../../images/gallery/pic1.jpg')}
                                alt=''
                              />
                  ...
                  <div className='content-box'>
                    <div className='content-header'>
                      <h3 className='title'>
                        <i className='la la-calendar-check-o m-r5'></i>events
                      </h3>
                    </div>
                    <div className='content-body'>
                      <div className='row'>
                        <div className='col-lg-6 col-md-6 col-sm-6'>
                          <div className='listing-bx event-listing m-b10'>
                            <div className='listing-media'>
                              <Link to={''}>
                                <img
                                  src={require('./../../images/featured/pic3.jpg')}
                                  alt=''
                                />
                              </Link>
                            </div>
                            <div className='listing-info'>
                              <h3 className='title'>
                                <Link to={''}>
                                  Moments To Remember From Directory
                                </Link>
                              </h3>
                              <ul className='event-meta'>
                                <li className='event-date'>
                                  <span>SEP</span> <strong>04</strong>
                                </li>
                                <li>Tuesday 08:00</li>
                        ...
                        <div className='col-lg-6 col-md-6 col-sm-6'>
                          <div className='listing-bx event-listing m-b10'>
                            <div className='listing-media'>
                              <Link to={''}>
                                <img
                                  src={require('./../../images/featured/pic2.jpg')}
                                  alt=''
                                />
                              </Link>
                            </div>
                  ...
                  <div className='content-box'>
                    <div className='add-reviews'>
                      <h5 className='title m-b0'>
                        <span className='text-primary'>24 </span>Reviews For
                        Triper
                      </h5>
                      <Link
                        data-toggle='modal'
                      ...
                      <div className='review-header'>
                        ...
                        <div className='clearfix d-flex'>
                          ...
                          <div className='dropdown dropdown-btn dropdown-btn-sm'>
                            <button
                              className='site-button-link button-xl dropdown-toggle'
                              type='button'
                              id='dropdownMenuButton'
                              data-toggle='dropdown'
                              aria-haspopup='true'
                            ...
                            >
                              <Link
                                ...
                                data-toggle='modal'
                                data-target='#report-reviews'
                                to={''}
                              >
                                <i className='la la-flag-o'></i>
                        ...
                        <div className='review-btn'>
                          <ul>
                            ...
                            <li>
                              <div className='dropdown dropdown-btn'>
                                <button
                                  className='site-button-link dropdown-toggle'
                                  type='button'
                                  id='dropdownMenuButton'
                                  data-toggle='dropdown'
                                  aria-haspopup='true'
                                  aria-expanded='false'
                                >
                                  <i className='la la-share-square-o m-r5'></i>{' '}
                                  Share
                                </button>
                                <div
                ...
                <div className='col-xl-4 col-lg-5 col-md-12 sticky-top'>
                  <aside className='side-bar listing-side-bar'>
                    <div className='content-box'>
                      <div className='content-header'>
                        <h3 className='title'>
                          <i className='la la-bullhorn m-r5'></i>Best Seller
                        </h3>
                      </div>
                      <div className='content-body'>
                        <div className='tour-booking-form'>
                          ...
                          <form className='row sp15'>
                            ...
                            <div className='form-group col-md-12'>
                              <button className='site-button btn-block text-uppercase button-md'>
                                Submit Enquiry
                              </button>
                            </div>
                          </form>
                    ...
                    <div className='content-box'>
                      <div className='content-header'>
                        <h3 className='title'>
                          <i className='la la-bullhorn m-r5'></i>listing sidebar
                          promotion
                        </h3>
                      </div>
                      <div className='content-body'>
                          ...
                          <div className='widget-post-bx'>
                            <div className='widget-post clearfix'>
                              ...
                              <div className='dlab-post-info'>
                                <div className='dlab-post-header'>
                                  <h6 className='post-title'>
                                    <Link to={''}>A Thing Of The Past</Link>
                                  </h6>
                                  <div className='dlab-post-meta'>
                                    <ul>
                                      <li className='post-rating'>
                          ...
                          <div className='widget-post-bx'>
                            <div className='widget-post clearfix'>
                              ...
                              <div className='dlab-post-info'>
                                <div className='dlab-post-header'>
                                  <h6 className='post-title'>
                                    <Link to={''}>Remember From Directory</Link>
                                  </h6>
                                  <div className='dlab-post-meta'>
                                    <ul>
                                      <li className='post-rating'>
                    ...
                    <div className='content-box'>
                      <div className='content-header'>
                        <h3 className='title'>
                          <i className='la la-map-signs m-r5'></i>business info
                        </h3>
                      </div>
                      <div className='content-body'>
                        ...
                        <Link to={''} className='site-button  btn-block gray'>
                    ...
                    <div className='content-box'>
                      <div className='content-header'>
                        <h3 className='title'>
                          <i className='la la-sitemap m-r5'></i>categories
                        </h3>
                      </div>
                      <div className='content-body'>
                    ...
                    <div className='content-box'>
                      <div className='content-header'>
                        <h3 className='title'>
                          <i className='la la-bar-chart m-r5'></i>statistic
                        </h3>
                      </div>
                      <div className='content-body'>
                        <ul className='icon-box-list list-col-2'>
                    ...
                    <div className='content-box'>
                      <div className='content-header'>
                        <h3 className='title'>
                          <i className='la la-tags m-r5'></i>tags
                        </h3>
                      </div>
                      <div className='content-body'>
                        <ul className='icon-box-list list-col-2'>
                    ...
                    <div className='content-box'>
                      <div className='content-header'>
                        <h3 className='title'>
                          <i className='la la-map-marker m-r5'></i>map
                        </h3>
                      </div>
                      <div className='content-body'>
                    ...
                    <div className='content-box'>
                      ...
                      <div className='content-body'>
                        ...
                        <Link to={''} className='site-button m-t5'>
                          Claim Now
                        </Link>
                      </div>
                    </div>
