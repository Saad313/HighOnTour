                ...
                <div className='blog-post blog-single blog-style-1'>
                  ...
                  <div className='dlab-post-title'>
                    <h4 className='post-title m-t0'>
                      <Link>
                        World’s largest Muslim group denounces Islamist
                        extremism
                      </Link>
                    </h4>
                  </div>
                  ...
                  <div className='dlab-post-text'>
                    <p>
                      ...
                      printing and typesetting printer a galley Lorem Ipsum is
                      simply dummy text of the printing and typesetting
                      industry. Lorem Ipsum has been the industry's standard
                      text ever since the 1500s, when an unknown printer took a
                      galley of type and scrambled it to make a type specimen It
                      has urvived not only five centuries, but also the leap
                      into electronic typesetting, remaining essentially
                      unchanged. It was popularised in 1960s with the release of
                    ...
                    <p>
                      ...
                      standard text ever since the 1500s, when an unknown
                      printer took a galley of type and scrambled it to make a
                      type specimen It has urvived not only five centuries, but
                    ...
                    <img
                      className='alignleft wow fadeIn blog-side-img'
                      data-wow-delay='0.2s'
                    ...
                    <p>
                      ...
                      centuries, but also the leap into electronic typesetting,
                      remaining essentially unchanged. It was popularised in the
                      1960s with the releasefive centuries, but also the leap
                      into electronic typesetting, remaining essentially
                    ...
                    <img
                      className='alignright wow fadeIn blog-side-img'
                      data-wow-delay='0.2s'
                  ...
                  <div className='dlab-post-tags clear'>
                    <div className='post-tags'>
                      {' '}
                      <Link>Child </Link> <Link>Eduction </Link>{' '}
                      <Link>Money </Link> <Link>Resturent </Link>{' '}
                    </div>
                  </div>
                  ...
                  <div className='share-details-btn'>
                    <ul>
                      ...
                      <li>
                        <Link className='site-button facebook button-sm'>
                          <i className='fa fa-facebook'></i> Facebook
                        </Link>
                      </li>
                      <li>
                        <Link className='site-button google-plus button-sm'>
                          <i className='fa fa-google-plus'></i> Google Plus
                        </Link>
                      </li>
                      <li>
                        <Link className='site-button linkedin button-sm'>
                          <i className='fa fa-linkedin'></i> Linkedin
                        </Link>
                      </li>
                      <li>
                        <Link className='site-button instagram button-sm'>
                          <i className='fa fa-instagram'></i> Instagram
                        </Link>
                      </li>
                      <li>
                        <Link className='site-button twitter button-sm'>
                          <i className='fa fa-twitter'></i> Twitter
                        </Link>
                      </li>
                      <li>
                        <Link className='site-button whatsapp button-sm'>
                    ...
                    <div className='clearfix m-b20'>
                        ...
                        <li className='comment'>
                          <div className='comment-body'>
                            ...
                            <div className='comment-meta'>
                              {' '}
                              <Link>October 6, 2015 at 7:15 am</Link>{' '}
                            </div>
                            <p>
                      ...
                      <div className='comment-respond' id='respond'>
                        <h4 className='comment-reply-title' id='reply-title'>
                          ...
                          <small>
                            {' '}
                            <Link id='cancel-comment-reply-link' rel='nofollow'>
                              Cancel reply
                            </Link>{' '}
                          </small>{' '}
                        </h4>
                ...
                <aside className='side-bar'>
                      ...
                      <div className='widget-post clearfix'>
                        ...
                        <div className='dlab-post-info'>
                          <div className='dlab-post-header'>
                            <h6 className='post-title'>
                              <Link href='blog-details.html'>
                                U.S. destroyer sails near disputed Chinese
                                island
                              </Link>
                            </h6>
                          </div>
                    ...
                    <ul>
                      <li>
                        <div className='dlab-post-thum'>
                          <Link className='dlab-img-overlay1 dlab-img-effect zoom-slow'>
                            <img
                              src={require('./../../images/gallery/pic2.jpg')}
                              alt=''
                            />
                          </Link>
                        </div>
                      ...
                      <li>
                        <div className='dlab-post-thum'>
                          <Link className='dlab-img-overlay1 dlab-img-effect zoom-slow'>
                            <img
                              src={require('./../../images/gallery/pic7.jpg')}
                              alt=''
                            />
                          </Link>
                        </div>
                      ...
                      <li>
                        <div className='dlab-post-thum'>
                          <Link className='dlab-img-overlay1 dlab-img-effect zoom-slow'>
                            <img
                              src={require('./../../images/gallery/pic8.jpg')}
                              alt=''
                            />
                          </Link>
                        </div>
                      ...
                      <li>
                        <div className='dlab-post-thum'>
                          <Link className='dlab-img-overlay1 dlab-img-effect zoom-slow'>
                            <img
                              src={require('./../../images/gallery/pic9.jpg')}
                              alt=''
                            />
                          </Link>
                        </div>
                  ...
                  <div className='widget widget_archive'>
                    ...
                    <ul>
                      ...
                      <li>
                        <Link>chastening</Link>
                      </li>
                      <li>
                        <Link>clerkship</Link>
                      </li>
                      <li>
                        <Link>disinclination</Link>
                      </li>
                    </ul>
                  </div>
