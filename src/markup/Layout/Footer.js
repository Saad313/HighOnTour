        ...
        return (
            <footer className="site-footer style1">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-5 footer-col-4">
                                <div className="widget widget_getintuch">
                                    ...
                                    <ul className="info-contact">
                                        <li>
                                            <span>
                                                <i className="fa fa-map-marker	"></i> Incubation Lab, First Floor, Huawei Center, U.E.T, Lahore
									</span>
                                        </li>
                ...
                <div className="footer-bottom">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6 col-md-6 text-left"> <span>Copyright © High On Tour</span> </div>
